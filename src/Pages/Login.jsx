        ...
        <>
            <section className="flex w-screen h-screen items-center justify-center">
                <div className="w-1/3 h-8/12 bg-[#3A3A3A] shadow-2xl shadow-black flex flex-col">
                    ...
                    <div className="flex flex-col h-2/3  justify-around gap-5 items-center "> 
                        <div className="bg-[#1F1F1F] w-2/3 h-1/6 pt-2 p-1">
                        ...
                        <div>
                            <input type="checkbox" name="Mostrar" id="0" value={showPassword} onChange={()=>{setShowPassword(!showPassword);}} />
                            <label htmlFor="0" className="text-white pl-1">Mostrar contraseña</label>
                        </div>
                        <div className="w-2/3 h-2/6 pt-2 p-1">
                ...
                <div className="w-1/3 h-8/12 bg-[#fff] shadow-lg shadow-black flex">
